...
const Footer = () => {
  return (
    <footer className="bg-alpine-gray text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/work" className="text-gray-300 hover:text-primary transition-colors">Our Work</Link></li>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a href="#" className="w-10 h-10 bg-alpine-gray-light/20 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
